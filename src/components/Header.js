    ...
    signupHandler=()=>{
        ...
        axios ({
            ...
            isSignupModalOpen:false
                ...
                this.setState({
                    isLoggedIn:false,
                    signUpError:"Error in signing up"
                })
            });
    }
    cancelSignupHandler =() =>{
                                ...
                                <div className="loginSection col-6">
                                    {
                                        ...
                                        ?
                                        <>
                                    <span className="text-white mt-4">{user.firstName}</span>
                ...
                <Modal isOpen={isLoginModalOpen} style={customStyles}>
                    ...
                    <form className="mt-4">
                        ...
                        <div className="mt-4">
                            ...
                            />
                            <GoogleLogin
                            clientId="936854599549-sd8f08ktghoc0khclq53pqnoeojrr3jr.apps.googleusercontent.com"
