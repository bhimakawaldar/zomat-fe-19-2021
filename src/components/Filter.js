...
class Filter extends Component{
    ...
    componentDidMount ()  {
        ...
        //make API calls to get the list of locations and filter by city_id
        axios   
    ...
    filterRestaurants(){
        // to do: logic to filter the restaurants
        const {
            mealTypeId,
            selectedLocation,
            cuisines,
                        ...
                        <div className="row">
                            <div className="leftSection col-xl-3 col-lg-4 col-md-5">
                               ...
                               <div className="filter-heading">Filters</div>
                                ...
                                <option valu="" >--Select Locations--</option>
                                    {
                                    ...
                                    <br/>
                                    <input type="radio" className="filter-cuisine" name="cost" onChange={(e) => this.handleCostChange(e,2000,10000)}  /> &#8377; 2000+
                                ...
                                <div className="resultSection">
                                    {
                                        ...
                                        restaurantList.map((item,index) => {
                                                return(
                                                    <div className="result"key={index} onClick={() => this.goToRestaurant(item)} >
